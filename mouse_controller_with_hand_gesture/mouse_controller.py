...
from mouse_controller_with_hand_gesture.model import KeyPointClassifier
...
def main():
    ...
    # Label Reading
    with open('mouse_controller_with_hand_gesture/model/keypoint_classifier/keypoint_classifier_label.csv',
    ...
    while True:
        ...
        if not ret:
            break
        image = cv.flip(image, 1)  # ミラー表示 Mirror Display
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                # Calculate of the center of gravity of the palm
        ...
        debug_image = draw_info(debug_image, margin_width, margin_height)
...
def draw_info(image, margin_width, margin_height):
    image_width, image_height = image.shape[1], image.shape[0]
